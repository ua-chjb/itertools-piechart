The basis for this dashboard miniapp is a program that iteratres through a number of feature-attribute pairs, to the order of between several thousand and several million combintations, to come up with drilled-down subsegments that have the most purity in terms of the dependent variable.
...
There are several ways to use the above program to analyze a set of data. In this example, the features were analyzed from a theoretical perspective - ie,  what factors may be present in the segmentation of houses, like "Zoning", "Style", "Garage", etc. By iterating through the program with various features, this program recursively goes deeper with each feature, to a maximum depth of 5.
...
This dashboard visualizes these results. [https://itertools-v1.ue.r.appspot.com/] (please give the server a few minutes for the pie chart to display)
